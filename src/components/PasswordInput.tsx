    ...
    <div className="relative">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute top-0 bottom-0 right-0 flex items-center justify-center w-10 text-gray-500 hover:text-gray-700 focus:outline-none z-20 cursor-pointer"
